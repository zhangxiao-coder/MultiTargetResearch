...
%         text(uav(j,7),uav(j,8)-2000,['(uav',num2str(2),')'],'color','b');
        ...
        plot(uav(1:j,7),uav(1:j,8),'c');
        rectangle('Position',[uav(j,7)-3000,uav(j,8)-3000,6000,6000],'Curvature',[1,1]),axis equal;
        text(uav(j,7),uav(j,8)-2000,['(uav',num2str(2),')'],'color','c');
        %text(uav(j,10),uav(j,11),['(target',num2str(uav(j,12)),')'],'color','c');
        
        plot(uav(1:j,10),uav(1:j,11),'m');
        rectangle('Position',[uav(j,10)-3000,uav(j,11)-3000,6000,6000],'Curvature',[1,1]),axis equal;
        text(uav(j,10),uav(j,11)-2000,['(uav',num2str(3),')'],'color','m');
...
%         text(uav(j,16),uav(j,17),['(target',num2str(uav(j,18)),')'],'color','y');
        ...
        plot(uav(1:j,13),uav(1:j,14),'k');
        rectangle('Position',[uav(j,13)-5000,uav(j,14)-5000,10000,10000],'Curvature',[1,1]),axis equal;
        text(uav(j,13),uav(j,14)-2000,['(uav',num2str(4),')'],'color','k');
%         text(uav(j,19),uav(j,20),['(target',num2str(uav(j,21)),')'],'color','k');
        
        plot(uav(1:j,16),uav(1:j,17),'r');
        rectangle('Position',[uav(j,16)-5000,uav(j,17)-5000,10000,10000],'Curvature',[1,1]),axis equal;
        text(uav(j,16),uav(j,17)-2000,['(uav',num2str(5),')'],'color','r');
